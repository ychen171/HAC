...
namespace HAC
{
    ...
    {
        private SystemManager05 m_Manager;
        ...
        public Form5()
        {
            ...
            price_file = new System.IO.StreamWriter("C:\\temp\\Data05.csv", true);
        ...
        private void OnSystemUpdate(double price, double qty, double fi, double f, double target, double stop)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (m_Manager != null)
            {
                ...
                m_Manager.Matcher.WriteBuys("C:\\temp\\Trade Matching Algos\\buys05.csv");
                m_Manager.Matcher.WriteSells("C:\\temp\\Trade Matching Algos\\sells05.csv");
                m_Manager.Matcher.WriteRoundTurns("C:\\temp\\Trade Matching Algos\\roundturns05.csv");
