...
namespace HAC
{
    ...
    {
        private SystemManager04 m_Manager;
        ...
        private void OnSystemUpdate(double price, double qty, double mfi, double mf, double target, double stop)
        {
            // Event handler prints the data to the GUI.
            textBox1.Text = (price / 100.00).ToString();
            textBox2.Text = mfi.ToString();
