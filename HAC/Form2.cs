...
namespace HAC
{
    public partial class Form2 : Form
    {
        ...
        public Form2()
        {
            ...
            price_file = new System.IO.StreamWriter("C:\\temp\\Data.csv", true);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (m_Manager != null)
            {
                ...
                m_Manager.Matcher.WriteBuys("C:\\temp\\Trade Matching Algos\\buys.csv");
                m_Manager.Matcher.WriteSells("C:\\temp\\Trade Matching Algos\\sells.csv");
                m_Manager.Matcher.WriteRoundTurns("C:\\temp\\Trade Matching Algos\\roundturns.csv");
